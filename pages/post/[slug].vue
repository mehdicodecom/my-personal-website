<template>
  ...
  <div class="relative xl:(ml-42 mr-40 px-22) lg:(ml-30 mr-30 px-18) md:(px-14 mt-30) sm:(px-8 mx-12 mt-30) xs:(px-6 mx-8 mt-24)">
    <!-- Development Notice -->
    <div class="bg-main-orange/20 text-white/80 text-sm text-center py-2 px-4 rounded-lg mb-6">
      🚧 This page is under development. Content is for testing purposes and not final.
    </div>
    ...
    >
      <button class="bg-dark-100 rounded-full p-2 hover:bg-dark transition duration-200">
    ...
    <!-- Hero Section -->
    <div class="relative bg-dark/70 rounded-lg flex flex-col items-center p-8 animate-fade-in">
      <div class="relative z-10 text-center">
        <div class="loading textLoading inline-block">
          <h1 class="font-medium text-3xl lg:text-4xl text-main-orange">{{ post.title }}</h1>
        </div>
      </div>
      <img
    ...
    <div class="flex lg:flex-row flex-col gap-8 mt-10">
      <!-- Main Content -->
      <div class="flex-1 bg-dark/70 rounded-lg p-8 border border-neutral-700 shadow-lg animate-slide-up">
        <div class="prose prose-invert prose-lg max-w-4xl mx-auto" v-html="post.content"></div>
        <!-- Share Button -->
        <div class="mt-8 flex justify-center">
          <a
            :href="shareUrl"
            target="_blank"
            class="inline-flex items-center gap-3 bg-gradient-to-r from-main-orange/20 to-main-orange/40 text-main-orange font-semibold text-lg px-6 py-3 rounded-lg hover:bg-gradient-to-r hover:from-main-orange/30 hover:to-main-orange/50 hover:scale-105 transition duration-200 shadow-md"
          >
            <svg class="w-6 h-6">
      ...
      <!-- Sidebar -->
      <aside class="lg:w-80 bg-dark/70 rounded-lg p-6 border border-neutral-700 shadow-lg lg:sticky lg:top-20 animate-slide-up">
