...
export default {
  ...
  computed: {
    ...
    twitterUrl() {
      return `https://x.com/intent/tweet?text=${this.encodedTitle}&url=${this.encodedUrl}`;
    },
    linkedinUrl() {
  ...
  methods: {
    ...
    trackShare(platform) {
      ...
      console.log(`Shared on ${platform}:`, this.title);
      this.dropdownOpen = false;
    }
  }
}
